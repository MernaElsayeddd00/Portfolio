...
* [cite_start]**BI Tool:** Looker Studio [cite: 122]
...
* [cite_start]**Data Cleaning & Normalization:** Standardized phone formats, converted timestamps, and handled null values across millions of rows of lead data[cite: 144].
...
## 📊 Business Impact
* [cite_start]**80% Reduction** in manual reporting time for the General Manager and Department Heads[cite: 144].
* [cite_start]**Performance Benchmarking:** Enabled the company to compare conversion rates across 5+ different clients for the first time[cite: 139].
