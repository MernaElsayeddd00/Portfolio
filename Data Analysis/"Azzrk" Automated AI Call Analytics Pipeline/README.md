...
* [Sample Data](./Sample Data.csv): Example CSV files following the `Leads_Company_Campaign` naming convention.
* [Dashboard Preview](./Dashboard Preview.pdf): Visual representation of the final BI tool.
